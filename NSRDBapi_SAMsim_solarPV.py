...
# Your affiliation
#your_affiliation = 'The+Nature+Conservancy'
#your_affiliation = 'NCEAS'
your_affiliation = 'UCSB'
#your_affiliation = 'UCBerkeley'

# Your email address
#your_email = 'grace.cc.wu@gmail.com'
#your_email = 'wu@nceas.ucsb.edu'
your_email = 'gracecwu@ucsb.edu'
#your_email = 'grace.cc.wu@berkeley.edu'

# You must request an NSRDB api key 
#api_key = '6RfgbvWUrnTbphfXG9cpU0bJaE5jk3LnA62F9WBW' #gmail
#api_key = 'HzzGnFBImZJF1uuAY6TLCqYnZzXwWAKPzcDbztcQ' #nceas
api_key = 'vZ0auELMt6M9KNcZOE9bKKhP28iLEkPS1ar5EOfx' #ucsb
#api_key = 'pZ1aUq8tpy2tIZDha4M7sEOhEzuIbYbur9CsQp2G' #berkeley.edu
