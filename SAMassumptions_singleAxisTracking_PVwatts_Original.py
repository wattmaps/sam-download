def singleAxisTracking(homePath, lat_in, lon_in, timezone_in, elevation_in, df_data_in):
	...
	#data = ssc.data_create()
	#ssc.data_set_string( data, b'solar_resource_file', b'/Applications/SAM_2021.12.02/SAM.app/Contents/solar_resource/des_moines_ia_41.586835_-93.624959_psmv3_60_tmy.csv' );
	...
	ssc.data_set_array_from_csv( data, b'grid_curtailment', b'/Users/grace/Documents/PathTo100_West/scripts/PoPWest/SAM_python_macos/SAMcodeGenerator_scratch/grid_curtailment.csv');
